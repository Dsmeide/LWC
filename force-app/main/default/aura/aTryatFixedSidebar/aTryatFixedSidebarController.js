({
    ...
    headerToggleSection : function(component, event, helper) {
        ...
        let tabBar = document.querySelector('div.slds-global-header');
        let warning = document.querySelector('div.oneSystemMessage');
        console.log(warning);
        console.log(tabBar);
        component.set('v.isHeaderCollapsed', !component.get('v.isHeaderCollapsed'));
    },
    scrollToTop: function(component, event, helper) {
        const main2 = component.find("main2").getElement();
        const sidebar = component.find("sidebar").getElement();
        sidebar.scrollTop = 0;
        main2.scrollTop = 0;
        // main2.scrollTo({ top:0, behavior: 'smooth'});
    ...
    scrollSidebarToTop: function(component, event, helper) {
        ...
        //     console.log("Created: Tab created.");
        //     helper.setSidebarTop(component);
        // },
    ...
    //     console.log(lastScrollTop + "last scroll top")
